...
const wchar_t* AppDomainManagerAssemblyName = L"Microsoft.Dnx.DomainManager.Clr, Version=1.0.0.0, Culture=neutral, PublicKeyToken=adb9793829ddae60, ProcessorArchitecture=MSIL";
    ...
    IStream **ppStmAssemblyImage, IStream **ppStmPDB)
{
    if (_wcsicmp(AppDomainManagerAssemblyName, pBindInfo->lpReferencedIdentity) == 0)
    {
        ...
        path.append(L"Microsoft.Dnx.DomainManager.Clr.dll");
